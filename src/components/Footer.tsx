            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div className="space-y-4">
                        <h3 className="text-2xl font-bold text-white">4Ads</h3>
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-2">
                            ...
                            <li><a href="#" className="hover:text-white transition-colors">Método</a></li>
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-2">
                            ...
                            <li><a href="#" className="hover:text-white transition-colors">Criativos</a></li>
                            <li><a href="#" className="hover:text-white transition-colors">Google Meu Negócio</a></li>
                            <li><a href="#" className="hover:text-white transition-colors">Consultorias</a></li>
                            <li><a href="#" className="hover:text-white transition-colors">Crescimento de Perfis</a></li>
                        </ul>
                    </div>
                ...
                <div className="mt-12 pt-8 border-t border-gray-800 text-center text-sm text-gray-400">
                    <p>&copy; 2024 4Ads. Todos os direitos reservados.</p>
                </div>
            </div>
        </footer>
    );
